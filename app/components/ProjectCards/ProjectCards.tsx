    ...
    <article className="flex flex-col px-9 py-8 h-[29rem] max-sm:h-[29rem] max-md:h-[30rem] mx-auto w-full text-base leading-none text-white rounded-xl bg-neutral-800 max-md:px-5 max-md:mt-10">
      ...
      <div className="mt-auto">
        <div className="border-2 border-stone-700 border-solid mt-5">
          <span className="absolute -mt-3 text-zinc-200 px-1 ml-2 bg-neutral-800 text-sm">Tech Stack</span>
        ...
        <div className="flex gap-2.5 mt-5 max-sm:mt-1 max-md:mt-1 justify-center w-full whitespace-nowrap">
          {props.source?.frontend && (
            <div className="mt-5 w-full text-center">
              <Link target="_blank" href={props.source.frontend} rel="noopener noreferrer">
                <button
                  className="text-yellow-500 shadow-[0_3px_10px_rgb(0,0,0,0.5)] px-2 py-2 rounded-md w-[30%] hover:text-black hover:bg-yellow-500 hover:scale-110 duration-300"
                  aria-label="View Frontend"
                >
                  Frontend
                </button>
              </Link>
              ...
              {props.source.backend && (
                <Link target="_blank" href={props.source.backend} rel="noopener noreferrer">
                  <button
                    className="text-yellow-500 shadow-[0_3px_10px_rgb(0,0,0,0.5)] px-2 py-2 rounded-md w-[30%] hover:text-black hover:bg-yellow-500 hover:scale-110 duration-300"
                    aria-label="View Backend"
                  >
                    Backend
                  </button>
                </Link>
              ...
              <Link target="_blank" href={props.link} rel="noopener noreferrer">
                <button
                  className="text-green-400 shadow-[0_3px_10px_rgb(0,0,0,0.5)] px-2 py-2 rounded-md w-[30%] hover:text-black hover:bg-green-400 hover:scale-110 duration-300"
          ...
          {props.source?.sourceLink && (
            <div className="mt-5 w-full text-center">
              <Link target="_blank" href={props.source.sourceLink} rel="noopener noreferrer">
                <button
                  className="text-yellow-500 shadow-[0_3px_10px_rgb(0,0,0,0.5)] px-2 py-2 rounded-md w-[47%] hover:text-black hover:bg-yellow-500 hover:scale-110 duration-300"
